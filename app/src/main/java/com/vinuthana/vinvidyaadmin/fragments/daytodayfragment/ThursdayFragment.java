...
public class ThursdayFragment extends Fragment {
    ...
    public void init() {
        ...
        recyclerViewThu = (RecyclerView) getActivity().findViewById(R.id.recyclerViewThu);
    }
    ...
    private class GetTimeTable extends AsyncTask<String, JSONArray, Void> {
        ...
        protected void onProgressUpdate(JSONArray... values) {
            ...
            recyclerViewThu.setLayoutManager(prntNtLytMngr);
            recyclerViewThu.setItemAnimator(new DefaultItemAnimator());
            recyclerViewThu.setAdapter(recyclerViewAdapter);
        }
