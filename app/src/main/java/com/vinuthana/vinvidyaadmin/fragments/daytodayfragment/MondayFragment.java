...
public class MondayFragment extends Fragment {
    ...
    public void init() {
        ...
        recyclerViewMon = getActivity().findViewById(R.id.recyclerViewMon);
    }
    ...
    private class GetTimeTable extends AsyncTask<String, JSONArray, Void> {
        ...
        protected void onProgressUpdate(JSONArray... values) {
            ...
            recyclerViewMon.setLayoutManager(prntNtLytMngr);
            recyclerViewMon.setItemAnimator(new DefaultItemAnimator());
            recyclerViewMon.setAdapter(recyclerViewAdapter);
        }
