...
public class StafFridayFragment extends Fragment {

    RecyclerView recyclerViewStfFri;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_staf_friday, container, false);
    }
    ...
    public void init() {
        ...
        recyclerViewStfFri = (RecyclerView) getActivity().findViewById(R.id.recyclerViewStfFri);
    }
    ...
    private class GetTimeTable extends AsyncTask<String, JSONArray, Void> {
        ...
        protected void onProgressUpdate(JSONArray... values) {
            ...
            recyclerViewStfFri.setLayoutManager(prntNtLytMngr);
            recyclerViewStfFri.setItemAnimator(new DefaultItemAnimator());
            recyclerViewStfFri.setAdapter(recyclerViewAdapter);
        }
