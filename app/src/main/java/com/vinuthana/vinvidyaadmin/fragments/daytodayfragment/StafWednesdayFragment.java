...
public class StafWednesdayFragment extends Fragment {

    RecyclerView recyclerViewStfWed;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_staf_wednesday, container, false);
    }
    ...
    public void init() {
        ...
        recyclerViewStfWed = (RecyclerView) getActivity().findViewById(R.id.recyclerViewStfWed);
    }
    ...
    private class GetTimeTable extends AsyncTask<String, JSONArray, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                timeTableData.put(getString(R.string.key_dayId), "3");
        ...
        protected void onProgressUpdate(JSONArray... values) {
            ...
            recyclerViewStfWed.setLayoutManager(prntNtLytMngr);
            recyclerViewStfWed.setItemAnimator(new DefaultItemAnimator());
            recyclerViewStfWed.setAdapter(recyclerViewAdapter);
        }
