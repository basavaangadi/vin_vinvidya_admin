...
public class StafThursdayFragment extends Fragment {

    RecyclerView recyclerViewStfThu;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_staf_thursday, container, false);
    }
    ...
    public void init() {
        ...
        recyclerViewStfThu = (RecyclerView) getActivity().findViewById(R.id.recyclerViewStfThu);
    }
    ...
    private class GetTimeTable extends AsyncTask<String, JSONArray, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                timeTableData.put(getString(R.string.key_dayId), "4");
        ...
        protected void onProgressUpdate(JSONArray... values) {
            ...
            recyclerViewStfThu.setLayoutManager(prntNtLytMngr);
            recyclerViewStfThu.setItemAnimator(new DefaultItemAnimator());
            recyclerViewStfThu.setAdapter(recyclerViewAdapter);
        }
