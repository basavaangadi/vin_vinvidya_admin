...
public class SaturdayFragment extends Fragment {
    ...
    public void init() {
        ...
        recyclerViewSat = (RecyclerView) getActivity().findViewById(R.id.recyclerViewSat);
    }
    ...
    private class GetTimeTable extends AsyncTask<String, JSONArray, Void> {
        ...
        protected void onProgressUpdate(JSONArray... values) {
            ...
            recyclerViewSat.setLayoutManager(prntNtLytMngr);
            recyclerViewSat.setItemAnimator(new DefaultItemAnimator());
            recyclerViewSat.setAdapter(recyclerViewAdapter);
        }
