...
public class WednesdayFragment extends Fragment {
    ...
    public void init() {
        ...
        recyclerViewWed = (RecyclerView) getActivity().findViewById(R.id.recyclerViewWed);
    }
    ...
    private class GetTimeTable extends AsyncTask<String, JSONArray, Void> {
        ...
        protected void onProgressUpdate(JSONArray... values) {
            ...
            recyclerViewWed.setLayoutManager(prntNtLytMngr);
            recyclerViewWed.setItemAnimator(new DefaultItemAnimator());
            recyclerViewWed.setAdapter(recyclerViewAdapter);
        }
