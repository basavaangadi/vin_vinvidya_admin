...
public class StafSaturdayFragment extends Fragment {

    RecyclerView recyclerViewStfSat;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_staf_saturday, container, false);
    }
    ...
    public void init() {
        ...
        recyclerViewStfSat = (RecyclerView) getActivity().findViewById(R.id.recyclerViewStfSat);
    }
    ...
    private class GetTimeTable extends AsyncTask<String, JSONArray, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                timeTableData.put(getString(R.string.key_dayId), "6");
        ...
        protected void onProgressUpdate(JSONArray... values) {
            ...
            recyclerViewStfSat.setLayoutManager(prntNtLytMngr);
            recyclerViewStfSat.setItemAnimator(new DefaultItemAnimator());
            recyclerViewStfSat.setAdapter(recyclerViewAdapter);
        }
