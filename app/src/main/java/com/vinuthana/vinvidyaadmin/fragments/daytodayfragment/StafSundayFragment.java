 ...
 */
public class StafSundayFragment extends Fragment {


    public StafSundayFragment() {
        // Required empty public constructor
    }
    RecyclerView recyclerViewStfSun;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_staf_sunday, container, false);
    }
    ...
    public void init() {
        ...
        recyclerViewStfSun = (RecyclerView) getActivity().findViewById(R.id.recyclerViewStfSun);
    }
    ...
    private class GetTimeTable extends AsyncTask<String, JSONArray, Void> {
        ...
        protected void onProgressUpdate(JSONArray... values) {
            ...
            recyclerViewStfSun.setLayoutManager(prntNtLytMngr);
            recyclerViewStfSun.setItemAnimator(new DefaultItemAnimator());
            recyclerViewStfSun.setAdapter(recyclerViewAdapter);
        }
