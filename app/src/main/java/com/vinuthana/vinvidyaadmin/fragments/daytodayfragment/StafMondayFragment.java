...
public class StafMondayFragment extends Fragment {
    RecyclerView recyclerViewStfMon;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_staf_monday, container, false);
    }
    ...
    public void init() {
        ...
        recyclerViewStfMon = (RecyclerView) getActivity().findViewById(R.id.recyclerViewStfMon);
    }
    ...
    private class GetTimeTable extends AsyncTask<String, JSONArray, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                timeTableData.put(getString(R.string.key_dayId), "1");
        ...
        protected void onProgressUpdate(JSONArray... values) {
            ...
            recyclerViewStfMon.setLayoutManager(prntNtLytMngr);
            recyclerViewStfMon.setItemAnimator(new DefaultItemAnimator());
            recyclerViewStfMon.setAdapter(recyclerViewAdapter);
        }
