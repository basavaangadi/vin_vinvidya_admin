...
public class ExamSchdlSpinnerAdapter extends BaseAdapter {
    LayoutInflater layoutInflater;
    JSONArray array;
    Context context;

    public ExamSchdlSpinnerAdapter(JSONArray array, Context context) {
        this.array = array;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        try {
            ...
            spinnerHolder.spinnerItemList.setText(jsonObject.getString(context.getString(R.string.key_Scheduledate)));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        return view;
