...
public class ReasonSpinnerAdapter extends BaseAdapter {
    ...
    public ReasonSpinnerAdapter(JSONArray array, Context context) {
        this.array = array;
    ...
    public Object getItem(int i) {
        try {
            return array.getJSONObject(i).getString(context.getString(R.string.key_ReasonId));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        try {
            ...
            spinnerHolder.spinnerItemList.setText(jsonObject.getString(context.getString(R.string.key_Reason)));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        return view;
