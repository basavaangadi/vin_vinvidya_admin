...
public class SectionSpinnerDataAdapter extends BaseAdapter {
    LayoutInflater layoutInflater;
    JSONArray array;
    Context context;

    public SectionSpinnerDataAdapter(JSONArray array, Context context) {
        this.array = array;
    ...
    public Object getItem(int i) {
        try {
            return array.getJSONObject(i).getString(context.getString(R.string.key_ClassId));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        try {
            ...
            spinnerHolder.spinnerItemList.setText(jsonObject.getString(context.getString(R.string.key_Section)));
        } catch (Exception ex) {
