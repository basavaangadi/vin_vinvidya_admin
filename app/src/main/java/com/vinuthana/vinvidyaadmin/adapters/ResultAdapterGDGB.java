...
public class ResultAdapterGDGB extends RecyclerView.Adapter<ResultAdapterGDGB.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            txtStudentNameGDGB.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    ClipboardManager cm = (ClipboardManager)context.getSystemService(Context.CLIPBOARD_SERVICE);
                    cm.setText(txtStudentNameGDGB.getText());
                    Toast.makeText(context, "Copied to clipboard", Toast.LENGTH_SHORT).show();

                }
            });
            txtRollNoGDGB.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    ClipboardManager cm = (ClipboardManager)context.getSystemService(Context.CLIPBOARD_SERVICE);
                    cm.setText(txtRollNoGDGB.getText());
                    Toast.makeText(context, "Copied to clipboard", Toast.LENGTH_SHORT).show();
            ...
            txtGradeGDGB.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    ClipboardManager cm = (ClipboardManager)context.getSystemService(Context.CLIPBOARD_SERVICE);
                    cm.setText(txtGradeGDGB.getText());
                    Toast.makeText(context, "Copied to clipboard", Toast.LENGTH_SHORT).show();
