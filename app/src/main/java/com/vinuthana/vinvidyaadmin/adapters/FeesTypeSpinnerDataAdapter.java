...
public class FeesTypeSpinnerDataAdapter extends BaseAdapter {

    JSONArray array;
    Context context;
    LayoutInflater layoutInflater;

    public FeesTypeSpinnerDataAdapter(JSONArray array, Context context) {
        this.array = array;
    ...
    public Object getItem(int position) {
        try {
            ...
            return object.getString("fees_type_Id");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            String strClass = jsonObject.getString("Fees_Type");
